# Generated by Powerlevel10k configuration wizard on 2023-05-13 at 14:47 MDT.
...
# vertical separators, slanted heads, flat tails, 2 lines, solid, no frame, compact,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  # typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=253
  # Custom icon.
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=247
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=228
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=10
