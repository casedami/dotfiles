...
vim.keymap.set("n", "<C-down>", "V:m '>+1<cr>gv=gv<esc>", { silent = true, desc = "Extend: move line down" })
vim.keymap.set("n", "<C-up>", "V:m '<-2<cr>gv=gv<esc>", { silent = true, desc = "Extend: move line up" })
vim.keymap.set("v", "<C-down>", ":m '>+1<cr>gv=gv", { silent = true, desc = "Extend: move line down" })
vim.keymap.set("v", "<C-up>", ":m '<-2<cr>gv=gv", { silent = true, desc = "Extend: move line up" })
