...
vim.keymap.set("n", "<leader>q", "<cmd>FzfLua args winopts.title='Bookmarks'<cr>", { desc = "Bookmarks: search bookmarks", silent = true })
vim.keymap.set("n", "<leader>g", "<cmd>FzfLua live_grep<cr>", { desc = "Finder: grep", silent = true })
vim.keymap.set("n", "<leader>Gs", "<cmd>FzfLua git_status<cr>", { desc = "Git: status", silent = true })
vim.keymap.set("n", "<leader>Gc", "<cmd>FzfLua git_bcommits<cr>", { desc = "Git: buffer commits", silent = true })
